...
\usepackage{fancyhdr,setspace,float,graphicx,lscape,array,longtable,colortbl,amsmath,amssymb,booktabs,multirow,hyperref,pdfpages,tocloft,titlesec,lipsum,natbib,standalone,lineno}
\usepackage{textcomp%
,footmisc%
,color%
,framed,xspace,xcolor
}
